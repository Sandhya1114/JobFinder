    ...
    <div className="about-container">
      ...
      <div className={`heroSection ${heroVisible ? 'hero-visible' : ''}`}>
        <div className="glass-hero-content">
          <h1 className="hero-title">About HirePath</h1>
      ...
      <div className="mission-section">
        <div className="glass-card mission-card">
          ...
          <p className="mission-text">
            At HirePath, we believe that finding the right job shouldn't be a full-time job itself. 
      ...
      <div className="cta-section">
        <div className="glass-card cta-card">
          ...
          <p className="cta-description">
            Join thousands of professionals who have already found their perfect career match with HirePath.
          </p>
