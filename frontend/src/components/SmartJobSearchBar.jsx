  ...
  const fuzzySearch = useCallback((items, query, limit = 8) => {
    ...
    return items
      .map(item => {
        ...
        // Word boundary
        else if (itemLower.split(' ').some(word => word.startsWith(queryLower))) score = 60;
    ...
    switch (type) {
      case 'jobSearch':
        const jobSuggestions = [
          ...fuzzySearch(searchData.jobTitles, query, 4),
          ...fuzzySearch(searchData.companies, query, 2),
          ...fuzzySearch(searchData.skills, query, 2)
        ];
        return jobSuggestions.slice(0, 8);
      ...
      case 'experience':
        return experienceOptions
          .filter(exp => exp.label.toLowerCase().includes(query.toLowerCase()))
          .slice(0, 8);
          ...
          <div ref={searchRefs.overlay} className="search-overlay-content">
            ...
            <div className="search-form-container">
              ...
              <div className="search-field-group">
                ...
                {activeDropdown === 'jobSearch' && suggestions.jobs.length > 0 && (
                  <div className="suggestions-dropdown">
                    {suggestions.jobs.map((suggestion, index) => (
                      <div
                        key={index}
