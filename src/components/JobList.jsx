        ...
        <div className="jobs-content">
          ...
          <div className="search-bar">
            <div className="search-field">
              <span className="icon"><a href="#" class="search fa fa-search"></a></span>
...
//           <div className="search-bar">
//             <div className="search-field">
//               <span className="icon"> <a href="#" class="search fa fa-search"></a></span> {/* You can replace this with an actual icon */}
//               <input
//                 type="text"
//                 placeholder="Enter skills / designations / companies"
//                 value={filters.searchQuery || ''} // Ensure it's not undefined
